...
export const doPriorityMatrix = (
  ...
  let priority = () => {
    if (mode === "calculation_default") {
      ...
      // | High             | P2   | P1     | P1    |
      const table = {
        // static at the moment, but clients will sometimes need to set their own table/matrix.
        "11": "P1",
        "12": "P1",
        "13": "P2",
        "21": "P1",
      ...
      const key =
        impact && urgency && (`${impact}${urgency}` as keyof typeof table);
