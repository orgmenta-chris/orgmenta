                ...
                <View key={"product_overview"}>
                    ...
                    >
                        ...
                        >
                            ...
                            <Text>
                                No mandatory demo or sales pressure, just sign
                                up and use it
                            </Text>
                            <Text>
                                (But sign up for a demo here if you want one
                                [link])
                            </Text>
                            <Text>
                                Dedicated Account Manager who will never abandon
                                you or charge for their time
                            </Text>
                            <Text>24/7 Support</Text>
                            <Text>
                                Consulting packages available for bespoke
                                requests
                            </Text>
                            <Text
                                style={{ fontWeight: "800", color: "#0c4a73" }}
                            ...
                            <Text>
                                All your entities and their relationships
                                brought into the hub
                            </Text>
                            <Text style={{ fontStyle: "italic" }}>
                                {mapTypeMain
                                    .map((x) => x.display_plural)
                                    .join(" <--> ")}
                            </Text>
                            <Text>Link Anything To Anything</Text>
                            <Text>
                                No restrictions - link any contact, to any
                                event, to any task, to any location, to any
                            ...
                            <Text>
                                Invoice your agreements and sales to your
                                customers
                            </Text>
                            ...
                            <Text>
                                Integrated Services (outsource your work to
                                on-demand technical experts)
                            </Text>
                            <Text>
                                MSP Community (peer/expert discussions and
                                groups)
                            </Text>
                            <Text
                                style={{ fontWeight: "800", color: "#0c4a73" }}
