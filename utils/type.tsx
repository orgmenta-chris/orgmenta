...
export const arrayTypeMain = [
  ...
  }, //L 10(was conflicting with Location but ok now.)
];
...
export const ViewTypeTabs = ({}: any) => {
  ...
  return (
    ...
    >
      {/* 'All' button */}
      <ViewContainerStatic style={{ flex: 1, width: 50, height: 50 }}>
        <ViewRouterLinkthemed
          style={{
            padding: 5,
            backgroundColor: 'gray'
          }}
          to={`entity/../../../all/display`}
        >
        ...
        <ViewContainerStatic key={i} style={{ flex: 1, width: 50, height: 50 }}>
          <ViewRouterLinkthemed
            style={{
              padding: 5,
              backgroundColor:
                display === (x as any).title.toLowerCase()
                  ? "gray"
                  : "lightgray",
            }}
