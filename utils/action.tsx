        ...
        <View style={{ flexDirection: "column" }}>
            ...
            <View style={{ flexDirection: "row" }}>
                <Pressable
                    ...
                    style={{
                        backgroundColor: state?.title ? "lightblue" : "gray",
                    }}
                    onPress={() => {
                        create.mutate();
        ...
        <View style={{ flexDirection: "column" }}>
            ...
            <View style={{ flexDirection: "row" }}>
                ...
                <Pressable
                    style={{
                        backgroundColor:
                            statusState === "0. New" ? "gray" : "lightblue",
                        margin: 2,
                        padding: 4,
                    }}
                ...
                <Pressable
                    style={{
                        backgroundColor:
                            statusState === "2. Active" ? "gray" : "lightblue",
                        margin: 2,
                        padding: 4,
                    }}
                ...
                <Pressable
                    style={{
                        backgroundColor:
                            statusState === "4. Hold" ? "gray" : "lightblue",
                        margin: 2,
                        padding: 4,
                    }}
