...
// NOW IN DATABASE (AND SEE STATIC NEWUSERROLES ARRAY AT THE BOTTOM OF THIS PAGE)
...
export const features = [
  {
      ...
      "class": "Feature",
      "categories": [
          "product-catalog-solutions-features"
      ],
      "title": "Update",
      "status": "0. New",
  ...
  },
  {
      ...
      "title": "History/Undo/Redo",
      "status": "0. New",
      "description": "Undo (and redo) to any point in entity-relationship histories Chris to design this",
      "priority": 2
  },
  {
      ...
      "title": "URL Parameters",
      "status": "0. New",
      "description": "Email (and other communication channels) Connectors see autotask live formulas, may be useful reference: https://ww1.autotask.net/help/content/4_admin/2featuressettings/livereports/addlivereport/Calculations/LRFormulas.htm",
      "priority": 2
  },
  {
  ...
  },
  {
      ...
      "title": "Asset (Configuration) Management",
      "status": "0. New",
      "description": "Manage client and internal workstations, servers, licenses, networks and any other tangible/intangible, physical/digital asset",
      "priority": 1
  },
  {
  ...
  },
  {
      ...
      "title": "Workflow Automations",
      "status": "0. New",
      "description": "Conditional logic,  rule running and template generations. If [a, b, c] then [x, y, z]",
      "priority": 2
  },
  {
  ...
  },
  {
      ...
      "title": "Lead Management",
      "status": "0. New",
      "description": "Lead, Quote, Prospect, Proposal management of potential customers",
      "priority": 2
  },
  {
  ...
  },
  {
      ...
      "title": "Internal Tool Creation",
      "status": "0. New",
      "description": "Allow client users to create their own tools & reports, instead of relying on their admin/dev team which has a longer, more costly dev cycle",
      "priority": 4
  },
  {
  ...
  },
  {
      ...
      "title": "Customer Satisfaction Surveys",
      "status": "0. New",
      "description": "CSAT, Net Promotor Score (NPS), Customer Effort Score (CES), Customer Loyalty Index (CLI),\tCustomer Satisfaction Index (CSI) etc. \n\t\t\tNet Promoter Score (NPS): NPS measures customer loyalty by asking customers how likely they are to recommend a product or service to others. Responses are typically on a scale of 0 to 10.\n\t\t\tCustomer Effort Score (CES): CES assesses the ease with which customers can achieve their goals when interacting with a product or service. It typically uses a scale to measure effort, with lower scores indicating less effort required.\n\t\t\tCustomer Loyalty Index (CLI): CLI combines various metrics to evaluate customer loyalty. It considers factors like repeat purchases, customer lifetime value, and advocacy.\n\t\t\tCustomer Satisfaction Index (CSI): CSI is a broad measure of overall satisfaction with a company's products or services. It often includes multiple survey questions to assess different aspects of the customer experience.\n\t\t\tOverall Satisfaction (OSAT): OSAT is a straightforward measure of overall customer satisfaction with a specific interaction, product, or service.\n\t\t\tCustomer Churn Rate: This metric measures the percentage of customers who stop using a product or service over a specific period, indicating dissatisfaction.\n\t\t\tCustomer Retention Rate: The opposite of churn rate, this measures the percentage of customers who continue using a product or service over time.\n\t\t\tSocial Media Sentiment Analysis: This involves analyzing social media comments, reviews, and mentions to gauge public sentiment and customer satisfaction.\n\t\t\tCustomer Feedback Forms: These can be custom surveys designed by companies to gather feedback on specific aspects of their products or services.\n\t\t\tOnline Reviews and Ratings: Monitoring and analyzing online reviews and ratings on platforms like Yelp, Google, or Amazon can provide insights into customer satisfaction.",
      "priority": 1
  },
  {
      ...
      "title": "Internal Communications Tool",
      "status": "0. New",
      "description": "Complete the implementation of the signup functionality:\n1. Defined the interface and placeholders for the signup related functions, but the actual logic is missing.\n2. Implement the requestAuthSignup and useAuthSignup functions according to your library's requirements.",
      "priority": 1
  },
  {
  ...
  },
  {
      ...
      "title": "Change Management",
      "status": "0. New",
      "description": "Change Requests, Change Approvals, Implementation Feebback, Rollback Options, Lessons Learned",
      "priority": 3
  },
  {
  ...
  },
  {
      ...
      "title": "Email Design",
      "status": "0. New",
      "description": "design email templates from within the PSA. (see https://news.ycombinator.com/item?id=37596253 loops and similar)",
      "priority": 3
  },
  {
  ...
  },
  {
      ...
      "title": "Shared Inbox",
      "status": "0. New",
      "description": "'One space for email, marketing, and customer relationships' (e.g. https://helpmonks.com/) and for employees to be able to view shared folders/inboxes",
      "priority": 2
  },
  {
  ...
  },
  {
      ...
      "title": "Change Password Functionality",
      "status": "0. New",
      "description": "Implement a function that allows users to change their passwords after signing in.",
      "priority": 1
  },
  {
      ...
      "title": "Password Recovery (Forgot Password) Functionality",
      "status": "0. New",
      "description": "Provide a function for users to recover their passwords through a password reset process. This involves sending password reset emails and allowing users to set a new password.",
      "priority": 1
  },
  {
      ...
      "title": "Social Authentication",
      "status": "0. New",
      "description": "Include functions for authenticating users using popular social media platforms like Google, Facebook, Twitter, etc.",
      "priority": 1
  },
  {
      ...
      "title": "Multi-Factor Authentication (MFA)",
      "status": "0. New",
      "description": "Implement support for multi-factor authentication to enhance security by adding an extra layer of verification.",
      "priority": 1
  },
  {
      ...
      "title": "Account Deactivation and Removal",
      "status": "0. New",
      "description": "Provide functions to allow users to deactivate or delete their accounts.",
      "priority": 1
  },
  {
      ...
      "title": "Account Verification and Email Confirmation",
      "status": "0. New",
      "description": "Implement functions to send verification emails and confirm user email addresses.",
      "priority": 1
  },
  {
      ...
      "title": "User Profile Management",
      "status": "0. New",
      "description": "Include functions to update user profile information, such as profile picture, display name, and other relevant details.",
      "priority": 1
  },
  {
      ...
      "title": "Session Management",
      "status": "0. New",
      "description": "Enhance session management by adding functions to check and refresh authentication tokens.",
      "priority": 1
  },
  {
      ...
      "title": "Role-Based Access Control (RBAC)",
      "status": "0. New",
      "description": "If applicable, include functions to manage user roles and permissions for different parts of the application.",
      "priority": 1
  },
  {
      ...
      "title": "Security Enhancements",
      "status": "0. New",
      "description": "Implement security features like brute-force protection, account lockout mechanisms, and IP blocking.",
      "priority": 1
  },
  {
      ...
      "title": "Event Hooks and Customization",
      "status": "0. New",
      "description": "Provide hooks and customization options to allow developers to integrate the authentication package seamlessly into their applications.",
      "priority": 1
  },
  {
      ...
      "title": "Localization and Internationalization",
      "status": "0. New",
      "description": "Support different languages and regions by including features for localization and internationalization.",
      "priority": 1
  },
  {
      ...
      "title": "Account Linking",
      "status": "0. New",
      "description": "Allow users to link multiple authentication methods to their account, such as email and social media accounts.",
      "priority": 1
  },
  {
      ...
      "title": "OAuth and OpenID Connect Integration",
      "status": "0. New",
      "description": "Integrate with OAuth and OpenID Connect providers for broader authentication options.",
      "priority": 1
  },
  {
      ...
      "title": "Analytics and Monitoring",
      "status": "0. New",
      "description": "Include features to track authentication-related events and provide monitoring capabilities.",
      "priority": 1
  },
  {
      ...
      "title": "Password Complexity and Policies",
      "status": "0. New",
      "description": "Provide options for setting and enforcing password complexity rules and policies.",
      "priority": 1
  },
  {
      ...
      "title": "OAuth2 / OIDC Server (for Advanced Use Cases)",
      "status": "0. New",
      "description": "If your package aims to cover advanced use cases, consider offering OAuth2 or OpenID Connect server capabilities.",
      "priority": 1
  },
  {
      ...
      "title": "Downtime detector",
      "status": "0. New",
      "description": "a la https://downdetector.com.au/ / https://www.pingdom.com/solution/website-down-detector/ / https://uptimerobot.com/",
      "priority": 5
  },
  {
  ...
  },
  {
      ...
      "title": "DNS Manager",
      "status": "0. New",
      "description": "Create a dns manager system for engineers to update from the PSA instead of logging into separate hosting instances.",
      "priority": 5
  },
  {
      ...
      "title": "Extra rich text functionality: Ability to paste tables, screenshots (etc.) into rich text",
      "status": "0. New",
      "description": "CW etc. does not allow you to paste csv or xlsx cells/tables into time entries with formatting. We should be able to retain the formatting when pasted in.",
      "priority": 5
  },
  {
      ...
      "title": "Password Manager",
      "status": "0. New",
      "description": "A la Bitwarden etc. Depends on appropriate securitty & security audit.",
      "priority": 3
  },
  {
      ...
      "title": "Payments System",
      "status": "0. New",
      "description": "Allow customers to pay our clients' invoices, downpayments etc. through Orgmenta. Via stripe if possible (allow clients to configure Stripe integration and accept payments, add products/sync products from Orgmenta etc.",
      "priority": 3
  }
]
export const usecases = [
  {
      ...
      "class": "Usecase",
      "categories": [
          "product-catalog-solutions-usecases"
      ],
      "title": "use a url with 'action' parameters in it, in order to prepopulate an action form. For example, add/title=example&type=Event should prepopulate a form.This means that the action tabs must be accessible via url."
  },
  {
  ...
  },
  {
      ...
      "title": "be able to put formulas in my url params, e.g. 'start=[today+3]', 'budget=[sum(childevents)+1]' etc."
  },
  {
      ...
      "title": "submit tickets through multiple channels (email, chat, phone) efficiently and minimise the time for it to be triaged, assigned and resolved."
  },
  {
  ...
  },
  {
      ...
      "title": "I want client enquiries to automatically create a ticket or update a relevant existing ticket."
  },
  {
      ...
      "title": "I want to be able to submit tickets through multiple channels (email, chat, phone) efficiently and minimise the time for it to be triaged, assigned and resolved."
  },
  {
      ...
      "title": "have incoming tickets automatically categorized based on keywords, so they can be triaged effectively."
  },
  {
      ...
      "title": "Have all support tickets created on a single pane of glass for me to triage and assign"
  },
  {
  ...
  },
  {
      ...
      "title": "submit tickets through multiple channels (email, chat, phone), so that I can reach support through my preferred method"
  },
  {
      ...
      "title": "perform automatic scans on client networks to populate asset data. (low priority, RMMs cover this)"
  },
  {
      ...
      "title": "link assets to tickets to better understand the scope of issues and easily click through to them for further information"
  },
  {
      ...
      "title": "see a utilization report for all managed assets, to understand overall performance."
  },
  {
  ...
  },
  {
      ...
      "title": "have items suggested automatically for 'cover letter' emails (e.g. if there is a price increase imminent, there should be a suggestion to alert customers 2 months before."
  },
  {
  ...
  },
  {
      ...
      "title": "automatically receive invoices on time to the commschannel of my choosing"
  },
  {
  ...
  },
  {
      ...
      "title": "integrate the PSA with accounting software for efficient reconciliation"
  },
  {
  ...
  },
  {
      ...
      "title": "insights into common ticket issues for a given period, to improve service."
  },
  {
  ...
  },
  {
      ...
      "title": "Assign (automatically or manually) primary and secondary (etc.) salespeople to a lead/quote/proposal/opportunity"
  },
  {
  ...
  },
  {
      ...
      "title": "have a dedicated account manager I can reach out to for non-technical issues"
  },
  {
  ...
  },
  {
      ...
      "title": "compliance features & reports that allow us to adhere to standards such as GDPR, HIPAA, etc"
  },
  {
  ...
  },
  {
      ...
      "title": "provide evidence to myself and external auditors that standards are being upheld."
  },
  {
  ...
  },
  {
      ...
      "title": "the PSA to integrate with VoIP systems so that communications can be logged and tracked within tickets."
  },
  {
      ...
      "title": "everything integrated into a single pane of glass (but only if it does not compromise on features or UX)"
  },
  {
  ...
  },
  {
      ...
      "title": "spin up a quick internal app (a la Retool) rather than spending months with the IT department /dev team"
  },
  {
  ...
  },
  {
      ...
      "title": "be able to single-click publish our corporate website and not worry about hosting, domains or pricing."
  },
  {
      ...
      "title": "make entities 'published' and public facing, and automatically go onto the correct page of our website (e.g. news, roadmap)"
  },
  {
  ...
  },
  {
      ...
      "title": "segment client accounts based on specific criteria (industry, size, location)"
  },
  {
      ...
      "title": "set up customized alerts for specific events, like SLA violations or system outages"
  },
  {
  ...
  },
  {
      ...
      "title": "synchronize my PSA calendar with external calendars (Google Calendar, Outlook)"
  },
  {
  ...
  },
  {
      ...
      "title": "mobile-friendly interface or app to update tickets while in the field"
  },
  {
  ...
  },
  {
      ...
      "title": "contingency plan feature that documents the steps to take in case of system failure"
  },
  {
  ...
  },
  {
      ...
      "title": "plan for capacity based on trends in ticket volume and resource utilization"
  },
  {
  ...
  },
  {
      ...
      "title": "the ability to white-label the PSA tool to maintain brand consistency. This includes custom domain / dns records to have the psa available under our corporate domain."
  },
  {
      ...
      "title": "extensive UI/UX customization capabilities to match our specific workflow needs."
  },
  {
  ...
  },
  {
      ...
      "title": "real-time inventory tracking within the PSA for hardware and software assets."
  },
  {
      ...
      "title": "See what stock we have on hand in order to provision a device for a customer."
  },
  {
  ...
  },
  {
      ...
      "title": "be able to sign off / give my blessing on a proposal, ticket or other entity"
  },
  {
  ...
  },
  {
      ...
      "title": "collate all client-related documents in one centralized repository."
  },
  {
  ...
  },
  {
      ...
      "title": "manage customer inquiries from social media channels within the PSA."
  },
  {
  ...
  },
  {
      ...
      "title": "I [MAY] want [THE OPTION] to earn rewards or recognition for achieving performance milestones [THAT IS NON-MANDATORY AND DOES NOT AFFECT PERFORMANCE ASSESSMENTS]. <-- CONTENTIOUS. (Or just make it a pleasant app to use!)"
  },
  {
      ...
      "title": "incorporate gamification elements to motivate and engage technicians."
  },
  {
  ...
  },
  {
      ...
      "title": "a live feed of ticket status updates for dynamic resource allocation."
  },
  {
  ...
  },
  {
      ...
      "title": "allow customers to access information themselves rather than having to come through me"
  },
  {
      ...
      "title": "log into my MSPs portal and see all open tickets, discussions, configurations, proposals etc."
  },
  {
      ...
      "title": "manage leave, holidays, and time-off within the same PSA system where work is being tracked."
  },
  {
      ...
      "title": "forecast and coordinate on-call teams, holidays, after hours coverage and emergency coverage"
  },
  {
  ...
  },
  {
      ...
      "title": "create, send, and track sales proposals within the PSA system to streamline the sales process."
  },
  {
      ...
      "title": "maintain a repository of proposal templates for different services and contract types."
  },
  {
      ...
      "title": "integrate proposal software with the PSA to ensure that pricing and asset lists are up-to-date."
  },
  {
  ...
  },
  {
      ...
      "title": "write notes/descriptions in the entities that are references/relationships (to other entities, with their attribute/relationship type) in them."
  },
  {
  ...
  },
  {
      ...
      "title": "Have anything I add into an entity's notes auto-added as relationships to the entity."
  },
  {
      ...
      "title": "add varying tax rules to invoice templates, territories, customers and other billing areas"
  },
  {
      ...
      "title": "multi-language and multi-currency support for international operations."
  },
  {
      ...
      "title": "set region-specific settings, like date formats and compliance standards."
  },
  {
  ...
  },
  {
      ...
      "title": "track and manage all vendor interactions, including quotations, lead times, and service quality, within the PSA system."
  },
  {
  ...
  },
  {
      ...
      "title": "filter expertise and assign an engineer with the skills commensurate to the project/service required."
  },
  {
      ...
      "title": "predictive analytics capabilities to forecast resource needs, revenue, and other key metrics."
  },
  {
  ...
  },
  {
      ...
      "title": "spin up charts/reports/dashboards (with the data available and related to me)"
  },
  {
  ...
  },
  {
      ...
      "title": "only allow a certain team access to information (i.e. a select few client employees"
  }
]
